  ...
  modal.innerHTML = `
    <div class="reference-modal-panel" role="dialog" aria-modal="true" aria-labelledby="userHelpTitle">
      ...
      <div class="reference-modal-body">
        ...
        <p>The <strong>Lists</strong> category appears automatically when a resource is a list rather than a normal service record.</p>
        <p>Some category pages include <strong>Type</strong> and <strong>For</strong> buttons that narrow the resources shown. For example, in Education, <strong>GED</strong> is a <strong>Type</strong> of educational resource, while <strong>Veterans</strong> identifies a group the resource is <strong>For</strong>.</p>
        <p>If you select more than one <strong>Type</strong> or <strong>For</strong> button, resources matching any selection are shown. Resources matching more of your selections appear first.</p>
        <h3>Search</h3>
        <p>Search is available on the <strong>Categories</strong> screen.</p>
        ...
        <p>Click <strong>${titleText}</strong> to see the current version number and recent updates and changes.</p>
        <h3>Merging Resource Updates</h3>
        <p>Click <strong>Categories</strong> in the top bar. The <strong>Merge Resources</strong> button is below the categories on the right side.</p>
        <p>Click <strong>Merge Resources</strong>. In the file picker, find and select the resource package zip file you received. Wait for the merge to finish.</p>
      </div>
    </div>
  `;
  const closeBtn = modal.querySelector(".reference-modal-close");
  ...
  modal.innerHTML = `
    <div class="reference-modal-panel" role="dialog" aria-modal="true" aria-labelledby="adminHelpTitle">
      ...
      <div class="reference-modal-body admin-help-content">
        ${adminEntryTipHTML}
        <p><strong>NOTE:</strong> The <strong>Lists</strong> category is generated automatically. It is not edited in <strong>Categories</strong>. A resource appears in <strong>Lists</strong> when it has no phone, website, or hours, which usually means it is a list such as food pantries, shelters, rooms, or temp agencies.</p>
        ...
        <details class="admin-training-section" ${expandTraining ? "open" : ""}>
          ...
          <div class="admin-help-section-body">
            ...
            <p>This walkthrough introduces the <strong>Categories</strong>, <strong>Resources</strong>, and <strong>For</strong> editors. You'll create a practice resource, assign <strong>Types</strong> and <strong>For</strong> groups, review the change log, save a resource package, and see how the update appears to users.</p>
            <p><strong>Setup for an untitled file:</strong> Most administrators can begin with the training steps below. Complete this setup step only if the blue bar says <code>&lt;New&gt; TSO Resources</code>.</p>
            <ol>
              <li>Change the TSO name. Close the tab or window, rename <code>new.html</code> to <code>[your tso name].html</code>, and reopen it.</li>
            </ol>
            <p><strong>Training steps:</strong></p>
            <ol>
              <li>Click <strong>Categories</strong> in the blue bar, then click the <strong>Education</strong> category. It says, <code>No resources in this category</code>.</li>
              <li>Click <strong>Admin</strong> in the blue bar.</li>
              <li>We'll discuss <strong>Save Resource Package</strong> later. <strong>Categories</strong>, <strong>Resources</strong>, and <strong>For</strong> are editors.</li>
              <li>On the left is a list of the standard categories. You can add <strong>New</strong> categories or <strong>Delete</strong> existing ones.</li>
              ...
              <li>Click <strong>Education</strong> in the list of categories.</li>
              <li><strong>Types</strong> describe specific kinds of help within a category. Education includes <strong>GED</strong> and other Types. The <strong>Resources in this category</strong> list on the right is empty.</li>
              <li>Click the <strong>For</strong> button above the list of categories. An Education resource, for example, might be for Spanish speakers.</li>
              <li>Click <strong>Resources</strong>. We'll create a practice resource that will tie all this together.</li>
              <li>Click <strong>New</strong>. Name the resource <code>Education Practice [your initials]</code>. Fill in something for <strong>Phone</strong>, <strong>Address</strong>, <strong>Website</strong>, and <strong>Hours</strong>.</li>
              <li>In <strong>Description</strong>, enter <code>This is a practice resource for training purposes.</code></li>
              <li>In <strong>Describe this update</strong>, enter <code>new</code>.</li>
              <li>In <strong>For</strong>, click <strong>Spanish speaking</strong> and <strong>Veterans</strong>.</li>
              <li>In <strong>Categories</strong>, click <strong>Education</strong> and then click <strong>GED</strong>.</li>
              <li>In the <strong>Information</strong> section, click <strong>Edit</strong>.</li>
...
* __this text is underlined__</code></pre>
                Now click the <strong>Preview</strong> button.
              </li>
              <li>Click the blue <strong>Done</strong> button, then click the <strong>Categories</strong> button in the blue bar.</li>
              <li><strong>Education</strong> now shows an <strong>Updates: [number]</strong> button. Select it to review the change. Then click <strong>Categories</strong> and click <strong>Education</strong> again.</li>
        ...
        <details>
          ...
          <div class="admin-help-section-body">
            ...
            <p>To load a newer resource package:</p>
            <ol>
        ...
        <details>
          ...
          <div class="admin-help-section-body">
            <p>Use <strong>Resources</strong> to add, edit, delete, categorize, assign For groups, and verify resource records.</p>
            ...
            <ul>
              <li><strong>Name</strong> is required and must be unique.</li>
              <li><strong>Phone</strong>, <strong>Address</strong>, <strong>Website</strong>, and <strong>Hours</strong> appear on the public resource card when filled in.</li>
              <li><strong>Verified</strong> stores a <code>MM/YY</code> date. Click <strong>Update</strong> to fill in the current month and year.</li>
              <li><strong>Description</strong> is the short public summary.</li>
              <li><strong>Describe this update</strong> is used in the change log and package update summary.</li>
              <li><strong>For</strong> identifies who the resource is for.</li>
              <li><strong>Categories</strong> determines which categories the resource will be part of and shows the Types available for each selected category.</li>
              <li><strong>Information</strong> is the detailed public service text.</li>
              <li><strong>PDFs</strong> lets you attach, open, or remove PDF files. Attached PDFs are included when you save a resource package.</li>
            </ul>
            <p>If a resource is a list, leave <strong>Phone</strong>, <strong>Website</strong>, and <strong>Hours</strong> blank so the app can place it in the generated <strong>Lists</strong> category.</p>
            <p><strong>Done</strong> saves the current edits. <strong>Cancel</strong> leaves the editor without applying those edits. If you leave <strong>Describe this update</strong> blank after changing a category or resource, the app asks whether you want to describe the change or save without a description.</p>
          </div>
        </details>
        ...
        <details>
          ...
          <div class="admin-help-section-body">
            <p>The resource <strong>Information</strong> editor contains the detailed public service text. Use <strong>Preview</strong> to check how the text will look.</p>
        ...
        <details>
          ...
          <div class="admin-help-section-body">
            ...
            <ul>
              ...
              <li><code>Renamed housing Type</code></li>
